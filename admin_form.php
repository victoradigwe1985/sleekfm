...
<body>
 ...
 <!-- ======= Header/Navbar ======= -->
  ...
  <!-- End Header/Navbar -->
    ...
    <!-- ======= Events Section ======= -->
    <center> <section id="events1" class="events">
      <div class="container" data-aos="fade-up">

        <div class="row">
          <div class="col-md-20 d-flex align-items-stretch">
            <div class="card">
              
              <div class="card-body">
         <div class="container" data-aos="fade-up">
   
   <h2  style="padding-bottom:5%;">Register Account</h2>
   <form class="form-horizontal" role="form" action="admin_handler.php" method="POST" >
      <div class="form-group">
      <label class="control-label col-sm-6" for="inputlg">First Name:</label>
      <div class="col-sm-10">          
          <input type="text" name="firstname" class="form-control input-lg" required="required" placeholder="Enter First Name">
      </div>
         </div><br>
         <div class="form-group">
      <label class="control-label col-sm-6" for="inputlg">Last Name:</label>
      <div class="col-sm-10">          
          <input type="text" name="lastname" class="form-control input-lg" required="required" placeholder="Enter Last name">
      </div>
         </div><br>
         <div class="form-group">
      <label class="control-label col-sm-6" for="inputlg">Username:</label>
      <div class="col-sm-10">          
          <input type="text" name="username" class="form-control input-lg" required="required" placeholder="Enter username">
      </div>
         </div><br>
         <div class="form-group">
      <label class="control-label col-sm-6" for="inputlg">Password:</label>
      <div class="col-sm-10">          
          <input type="password" name="password" class="form-control input-lg" required="required" placeholder="Enter password">
      </div>
    </div><br>
           <div class="form-group">
      <label class="control-label col-sm-6" for="inputlg">Confirmed Password:</label>
      <div class="col-sm-10">          
          <input type="password" name="confirm_password" class="form-control input-lg" required="required" placeholder="Enter password">
      </div>
    </div>
         <div class="form-group">      
      <div class="col-sm-offset-2 col-sm-10">
          <button style="background-color:lightgreen; margin:4px;" type="submit"  name="submit" class="btn">Register</button>
      </div>
    </div>
  </form>
        ...
        </section></center><!-- End Events Section -->
